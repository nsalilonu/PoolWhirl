...
// storm clouds, rain and lightning integrated 
// (hard to find good start and end points for the lightning relative to 
// the storm) 
...
window.onload = function () {
    ...
    let material = new MeshLineMaterial({color: new THREE.Color(0x7df9ff)});
